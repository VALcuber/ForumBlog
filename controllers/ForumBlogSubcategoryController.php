<?php
/** @used-by Router */
class ForumBlogSubcategoryController extends Controller{

    private $pageTpl = '/templates/forum-blog-sub.tpl';

    public function __construct() {
        parent::__construct();
        $this->model = new ForumBlogSubcategoryModel();
        $this->view = new View();
    }
    ...
    public function index() {
        ...
        // Handle post request
        if ($env['act']  === 'Post') {
            $this->model->add_ForumBlog_sub_content($_POST['target'] ?? '');
        }
        ...
        $latest = $this->model->latest_ForumBlog_sub_posts();
