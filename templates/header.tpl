    ...
    <div class="container-fluid bg-white wrapper">
        ...
        <div class="row px-4 py-2">
            ...
            <div class="header__column d-flex align-items-center justify-content-end">
                ...
                <a href="/userprofile" class="header__profile text-center d-none d-sm-block rounded-circle" data-toggle="modal" data-target="#signinModal"><?= $pageData['check'] ?></a> <!--data-toggle="modal" data-target="#signinModal"-->
